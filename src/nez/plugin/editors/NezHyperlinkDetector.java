...
public class NezHyperlinkDetector implements IHyperlinkDetector {
	NezEditor editor;

	public void init(NezEditor editor) {
		this.editor = editor;
	}
	...
	public IHyperlink[] detectHyperlinks(ITextViewer textViewer,
		...
		IProject project = NezEUtil.getProject();
		if (project == null)
			return null;
		...
		return new IHyperlink[]{new NezHyperlink(region, new Region(
